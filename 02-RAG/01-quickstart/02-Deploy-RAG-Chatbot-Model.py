...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-rag-chatbot-chandhana_padmanabhan` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0402-203530-ojum5yzg/configuration)). <br />
...
# MAGIC %sql
# MAGIC GRANT EXECUTE ON DATABASE `main`.`rag_chatbot` TO `68df7d8e-8bf7-43d3-b55d-534855fb1c42`;
# MAGIC GRANT USAGE ON CATALOG `main` TO `68df7d8e-8bf7-43d3-b55d-534855fb1c42`;
# MAGIC GRANT USAGE ON DATABASE `main`.`rag_chatbot` TO `68df7d8e-8bf7-43d3-b55d-534855fb1c42`;

# COMMAND ----------

from databricks.sdk import WorkspaceClient
import databricks.sdk.service.catalog as c
WorkspaceClient().grants.update(c.SecurableType.TABLE, "main.rag_chatbot.databricks_documentation_vs_index_cp",
changes=[c.PermissionsChange(add=[c.Privilege["SELECT"]], principal="68df7d8e-8bf7-43d3-b55d-534855fb1c42")])
...
index_name=f"{catalog}.{db}.databricks_documentation_vs_index_cp"
